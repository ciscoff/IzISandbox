...
import s.yarlykov.izisandbox.matrix.avatar_maker_dev.MediaDataConsumer

class AvatarCompoundViewV1 @JvmOverloads constructor(
    context: Context,
    ...
    init {
        View.inflate(context, R.layout.layout_avatar_components_v1, this).also { view ->
