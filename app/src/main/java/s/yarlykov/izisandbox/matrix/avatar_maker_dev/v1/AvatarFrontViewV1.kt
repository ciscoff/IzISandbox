package s.yarlykov.izisandbox.matrix.avatar_maker_dev.v1
...
import s.yarlykov.izisandbox.matrix.avatar_maker_dev.gesture.lb
import s.yarlykov.izisandbox.matrix.avatar_maker_dev.gesture.lt
import s.yarlykov.izisandbox.matrix.avatar_maker_dev.gesture.rb
import s.yarlykov.izisandbox.matrix.avatar_maker_dev.gesture.rt
 ...
 * ViewPadding в родительском контейнере отчасти решил проблему, но мне кажется, что можно пойти
